                            ...
                            <form id="msform" action="{{ url('new-registration/store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <fieldset>
                                    <div class="form-card">
                                        ...
                                        <label class="fieldlabels" style="margin-top:25px;">Details of Displayed Product:<span class="text-danger">*</span></label>
                                        ...
                                        <label class="fieldlabels" style="margin-top:25px;">SSM Certificate:<span class="text-danger">*</span></label>
                                        <input type="file" name="ssm_cert" id="formFile" style="margin-bottom:0;" required>
                                        <em style="font-size: 10pt;">File format: docx, csv, txt, xlx, xls, pdf</em>

                                        <label class="fieldlabels" style="margin-top:25px;">Vaccine Certificate:<span class="text-danger">*</span></label>
