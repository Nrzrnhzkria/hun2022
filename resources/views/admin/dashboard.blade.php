    ...
    <div class="row pb-4">
      ...
      <div class="col-md-4">
        <div class="card border-0 shadow text-center" style="height: 22rem">
          ...
          <canvas id="memberChart" style="width:100%; max-width:600px; height:60%; max-height:800px;"></canvas>
          <div class="table-responsive p-2">
            <table class="table table-borderless table-sm">
              <tr>
                <td class="text-end">Members</td>
                <td style="width: 1rem">:</td>
                <td class="text-start"style="width: 6rem">{{ $member }}</td>
              </tr>
              <tr>
                <td class="text-end">Non-members</td>
                <td style="width: 1rem">:</td>
                <td class="text-start" style="width: 6rem">{{ $nonmember }}</td>
              </tr>
            </table>
          </div>
        </div>
