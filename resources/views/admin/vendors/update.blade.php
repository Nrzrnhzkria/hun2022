...
<div class="container pb-4">
    ...
    <div class="row justify-content-center py-5">
        <div class="col-md-8">
            <div class="card py-5">
                <div class="card-body">
                    <form class="row g-3 px-3" method="POST" action="{{ url('edit') }}/{{ $vendor->id }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="hun_id" type="text" class="form-control @error('hun_id') is-invalid @enderror" name="hun_id" value="{{ $vendor->hun_id }}" required autocomplete="hun_id" autofocus>
